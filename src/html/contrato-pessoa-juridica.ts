...
export interface InfoPessoaisJuridicaFormParams {
    nomeEmpresaCompleto: string;
    nomeRepresentanteCompleto: string;
    rg?: string;
    cpf: string;
    cnpj: string;
    rua: string;
...
<body>
    ...
    <div class="section">
        ...
        <p><strong>${infoPessoais.nomeEmpresaCompleto}, CNPJ ${infoPessoais?.cnpj
        }</strong>, com sede na   <strong>${infoPessoais?.rua} ${infoPessoais?.numero
        } - ${infoPessoais?.bairro}, CEP ${infoPessoais?.cep} - ${infoPessoais?.cidade
        }/${infoPessoais?.estado}.</strong></p>
    <p>neste ato
representada por seu representante legal ${infoPessoais.nomeRepresentanteCompleto
        }, portador do CPF ${infoPessoais?.cpf}.</p> 
    </div>
