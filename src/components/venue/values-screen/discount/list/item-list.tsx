...
export function SeasonalFeeItemFlatList({
  ...
  return (
    ...
    >
        <StyledText className="w-full text-[16px] font-bold text-custom-white text-center">{seasonalFee.title}</StyledText>
      <StyledView className="flex flex-row justify-between items-center w-full mx-auto mt-5">
        ...
        <StyledView className="flex flex-col justify-center items-center gap-y-1 w-[33%]">
          <StyledText  className="w-full text-[16px] font-bold text-custom-white text-center" > - {seasonalFee.fee} %</StyledText>
        </StyledView>
      </StyledView>
