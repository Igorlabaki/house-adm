...
export const updateProposalPerDayRequestParamsSchema = z.object({
    proposalId: z.string(),
    data: z.object({
...
export type UpdateProposalPerDayRequestParamsSchema = z.infer<typeof updateProposalPerDayRequestParamsSchema>;