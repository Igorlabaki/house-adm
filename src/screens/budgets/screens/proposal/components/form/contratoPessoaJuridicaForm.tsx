...
import {
  ...
  generateContractJuridicaFormSchema,
} from "@schemas/generateContractJuridicaFormZodSchema";
...
import { InfoPessoaisJuridicaFormParams } from "html/contrato-pessoa-juridica";
...
import { ContractType, OwnerVenueType, ProposalType } from "type";
...
export default function ContratoPessoaJuridicaForm() {
  ...
  return (
    <Formik
      ...
      onSubmit={async (values: GenerateContractJuridicaFormSchema) => {
        ...
        <StyledView className="w-[90%] mx-auto my-5 flex flex-col gap-y-2">
          ...
          <StyledView className="flex flex-col gap-y-1">
            ...
            <StyledTextInputMask
              ...
              placeholder={
                errors.cnpj ? String(errors.cnpj) : "Digite o cnpj do locatario"
              }
            ...
            <>
              <StyledView className="flex flex-col gap-y-2">
                ...
                <StyledTextInputMask
                  ...
                  value={String(Number(values.paymentInfo?.signalAmount) * 100)}
                />
                {errors?.paymentInfo?.signalAmount &&
